...
export const set8: Question[] = [
    ...
    },
    {
        ...
        "correctAnswer": "C",
        "explanation": "1. Căn cứ pháp lý về Mẫu hồ sơ: Theo Khoản 4 Điều 4 Thông tư 79/2025/TT-BTC, đối với gói thầu mua sắm hàng hóa áp dụng hình thức đấu thầu rộng rãi qua mạng, một giai đoạn một túi hồ sơ, Chủ đầu tư sử dụng Mẫu số 4A để lập E-HSMT.\n2. Quy định về \"Hàng hóa tương tự\": Trong các Mẫu hồ sơ mời thầu mua sắm hàng hóa qua mạng (Mẫu 4A), tiêu chuẩn đánh giá về kinh nghiệm thực hiện hợp đồng tương tự quy định khái niệm \"Hàng hóa tương tự về tính chất\" để đảm bảo tính cạnh tranh và công bằng. Theo đó, hàng hóa được xem là tương tự khi đáp ứng một trong hai điều kiện:\n    - Cùng chủng loại: Là hàng hóa có cùng công năng, tính năng sử dụng chính (ví dụ: máy điều hòa tương tự với máy điều hòa).\n    - Cùng mã HS: Có cùng mã Chương, mã Nhóm (tương ứng với 4 số đầu tiên của bộ mã) trong Hệ thống hài hòa mô tả và mã hóa hàng hóa (HS). Việc xác định mã HS cũng được yêu cầu khi công khai thông tin kết quả lựa chọn nhà thầu theo Khoản 4 Điều 20 Thông tư 79/2025/TT-BTC.\n3. Lý do loại trừ các phương án khác:\n    - Phương án \"Quy định hàng hóa thuộc cùng lĩnh vực tổng quát...\": Sai vì quá rộng và mơ hồ, không đảm bảo nhà thầu có kinh nghiệm cụ thể với loại hàng hóa cần mua.\n    - Phương án \"Chỉ quy định hàng hóa có cùng mã Chương, mã Nhóm...\": Sai vì từ \"Chỉ\" mang tính hạn chế. Nhà thầu có thể cung cấp hàng hóa cùng chủng loại (cùng là máy điều hòa) nhưng khác mã HS (do đặc tính kỹ thuật chi tiết khác nhau) vẫn được chấp nhận là có kinh nghiệm tương tự. Quy định bắt buộc phải dùng từ \"hoặc\" để mở rộng cơ hội cho nhà thầu.\nKết luận: Trong E-HSMT gói thầu mua sắm hàng hóa, tính chất tương tự của hàng hóa trong hợp đồng cũ được xác định là hàng hóa cùng chủng loại HOẶC hàng hóa có cùng 4 số đầu của mã HS.",
        "category": "Hồ sơ mời thầu và Đánh giá HSDT"
    },
    {
        "id": 74,
